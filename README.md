...
| `sensor`        | Show info from RadiaCode 101 sensor component API. |
...
7. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "RadiaCode 101 sensor component"

Using your HA configuration directory (folder) as a starting point you should now also have this:

```text
custom_components/radiacode_bt/translations/en.json
custom_components/radiacode_bt/translations/fr.json
custom_components/radiacode_bt/translations/nb.json
custom_components/radiacode_bt/translations/sensor.en.json
custom_components/radiacode_bt/translations/sensor.fr.json
custom_components/radiacode_bt/translations/sensor.nb.json
custom_components/radiacode_bt/translations/sensor.nb.json
custom_components/radiacode_bt/__init__.py
custom_components/radiacode_bt/api.py
custom_components/radiacode_bt/binary_sensor.py
...
custom_components/radiacode_bt/switch.py
```
