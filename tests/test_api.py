"""Tests for RadiaCode 101 sensor component api."""
import asyncio

import aiohttp
from custom_components.radiacode_bt.api import (
    RadiacodeBtApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = RadiacodeBtApiClient("test", "test", async_get_clientsession(hass))
